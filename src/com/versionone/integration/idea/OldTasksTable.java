...
/**
 */
public class OldTasksTable extends Table {
    ...
    public OldTasksTable(OldTasksModel v1TableModel, IDataLayer data) {
        super(v1TableModel);
        this.data = data;
    }

    @Override
    public OldTasksModel getModel() {
        return (OldTasksModel) super.getModel();
    }
